...
const productionPages = [
  ...
  "work/negative-result-warrant/index.html",
...
test("the public directory is an explicit, reviewable allowlist", async () => {
  const expected = [
    ...
    "robots.txt",
    "sitemap.xml",
    "tools/agent-closure-inspector/browser-local.js",
    ...
    "tools/consequence-closure/current/app.js",
    "tools/consequence-closure/current/index.html",
    "tools/consequence-closure/current/provenance.json",
    "tools/consequence-closure/current/styles.css",
    "tools/consequence-closure/current/worker.js",
    "tools/consequence-closure/index.html",
    ...
    "tools/negative-result-warrant/index.html",
    "tools/negative-result-warrant/inspector-refresh.css",
